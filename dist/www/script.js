...
var setStyles = function setStyles(el, styles) {
  __WEBPACK_IMPORTED_MODULE_3_babel_runtime_core_js_object_keys___default()(styles).forEach(function (key) {
    el.style[key] = styles[key];
  });
};

var setAttrs = function setAttrs(el, attrs) {
  __WEBPACK_IMPORTED_MODULE_3_babel_runtime_core_js_object_keys___default()(attrs).forEach(function (key) {
...
var siiimpleToast = {
  ...
  setOptions: function setOptions() {
    ...
    return __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_extends___default()({}, siiimpleToast, {
      defaultOptions: __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_extends___default()({}, this.defaultOptions, options)
    });
  },
  render: function render(state, message) {
    var _this = this;

    var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};

    var mergedOptions = __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_extends___default()({}, this.defaultOptions, options);
    ...
    var time = 0;
    setTimeout(function () {
      _this.show(newToast, mergedOptions);
    }, time += delay);
    setTimeout(function () {
      _this.hide(newToast, mergedOptions);
    }, time += duration);

    // support method chaining
    return this;
  },
  show: function show(el, _ref) {
    var _setStyles;
    ...
    setStyles(el, (_setStyles = {
      position: container === 'body' ? 'fixed' : 'absolute'
    }, __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_defineProperty___default()(_setStyles, hasPos(el, 'top') ? 'top' : 'bottom', '-100px'), __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_defineProperty___default()(_setStyles, hasPos(el, 'left') && 'left', '15px'), __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_defineProperty___default()(_setStyles, hasPos(el, 'center') && 'left', root.clientWidth / 2 - el.clientWidth / 2 + 'px'), __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_defineProperty___default()(_setStyles, hasPos(el, 'right') && 'right', '15px'), _setStyles));
    ...
    __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_array_from___default()(document.querySelectorAll('.' + className + '[data-position="' + getAttr(el, 'data-position') + '"]')).filter(function (toast) {
      return toast.parentElement === el.parentElement;
    }) // matching container
    .forEach(function (toast) {
      setStyles(toast, __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_defineProperty___default()({}, hasPos(toast, 'top') ? 'top' : 'bottom', pushStack + 'px'));
  ...
  hide: function hide(el) {
    ...
    setStyles(el, (_setStyles3 = {}, __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_defineProperty___default()(_setStyles3, hasPos(el, 'left') && 'left', width + 'px'), __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_defineProperty___default()(_setStyles3, hasPos(el, 'center') && 'left', left + width + 'px'), __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_defineProperty___default()(_setStyles3, hasPos(el, 'right') && 'right', '-' + width + 'px'), __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_defineProperty___default()(_setStyles3, 'opacity', 0), _setStyles3));
  ...
  message: function message(_message, options) {
    return this.render('default', _message, options);
  },
  success: function success(message, options) {
    return this.render('success', message, options);
  },
  alert: function alert(message, options) {
    return this.render('alert', message, options);
  }
};

/* harmony default export */ __webpack_exports__["default"] = (siiimpleToast);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_animejs__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_animejs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_animejs__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_main__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_style_scss__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_style_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__src_style_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__styles_main_scss__ = __webpack_require__(73);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__demo__ = __webpack_require__(74);
// eslint-disable-line
...
document.addEventListener('DOMContentLoaded', () => {
  const topleftToast = __WEBPACK_IMPORTED_MODULE_1__src_main__["default"].setOptions({
    position: 'top|left',
  });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_main__ = __webpack_require__(28);
...
buttons.forEach((button) => {
  document.querySelector(`[data-btn="${button}"]`).addEventListener('click', () => {
    state = button;
    changePreText();
    __WEBPACK_IMPORTED_MODULE_0__src_main__["default"][state](options.message, options);
  });
});
